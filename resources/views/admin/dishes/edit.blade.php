...
<div class="row">
	<div class="col-12">
		...
		<div class="card card-primary">
			...
			<!-- /.card-header -->
			<!-- form start -->
			<form role="form" id="createForm" method="POST" action="{{url('/admin/dishes/'.$dish->id.'/update')}}"
				...
				<div class="card-body">
					...
					{{-- <x-form-elements name="addon_id[]" multiple type="select2" label="Select Addons"
						value="{{old('addon_id[]', $dish->dish_addons->pluck('id')->toArray())}}" :options="$addons" required /> --}}
