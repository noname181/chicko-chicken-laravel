...
<div class="row">
	<div class="col-12">
		...
		<div class="card card-primary">
			...
			<!-- /.card-header -->
			<!-- form start -->
			<form role="form" id="createForm" method="POST" action="{{url('/restaurant-owner/dish_categories/store')}}"
				enctype="multipart/form-data">
				@csrf
				<div class="card-body">
					@include('errors.errors-forms')

					<x-form-elements name="name" type="text" label="Category Name" value="{{old('name')}}" required />
					...
					<x-form-elements name="active" type="switch" checked label="Active" value="{{old('active')}}" />
				</div>
				<!-- /.card-body -->
